...
import logo from "/src/ASSETS/frontend/assets/logo.svg";
import  logout  from "../ASSETS/frontend/assets/logout.svg";
...
const Header = () => {
  ...
  console.log("Logout icon path: ", logout);
  console.log("User icon path: ", user)
      ...
      <div className="px-4 flexBetween py-3 max-xs:px-2">
        ...
        <div className="flexBetween sm:gap-x-2 bold-16 ">
          ...
          <NavLink to={"cart-page"} className="flex">
            ...
            {/* <NavLink to={'logout'} className={"btn_secondary_rounded flexCenter gap-x-2 medium-16"}><img src={logout} alt="logutIcon" height={19} width={19} /> Logout
          </NavLink> */}
          <NavLink to={'login'} className={"btn_secondary_rounded flexCenter  gap-x-2 medium-16 "} ><div><img src={user} alt="userIcon" height={19} width={19} /></div>Login</NavLink>
        </div>
      </div>
    </header>
  );
