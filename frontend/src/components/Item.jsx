  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg">
      <div className="relative flexCenter group overflow-hidden transition-all duration-100">
        <Link
           to={`/product/${id}`}
          className="h-12 w-12 bg-white rounded-full  flexCenter  absolute  top-1/2 !py-2 z-20  transition-all duration-700"
        >
      ...
      <div className="p-4 overflow-hidden">
        <h4 className="my-[6px] medium-16 line-clamp-2 text-gray-700">
          {name}
        </h4>
