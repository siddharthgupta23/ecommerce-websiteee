...
import product_rt_2 from '../ASSETS/frontend/assets/product_rt_2.png';
import product_rt_3 from '../ASSETS/frontend/assets/product_rt_3.png';
import product_rt_4 from '../ASSETS/frontend/assets/product_rt_4.png';
   ...
   <section className='flex flex-col gap-14 xl:flex-row'>
    <div className="flex gap-x-4 xl:flex-1">
        ...
        <div className='mb-4'>
            ...
            <div className="flex-gap my-3">
                <div className="ring-2 ring-slate-900 h-10 w-10 flexCenter cursor-pointer">S</div>
                <div className="ring-2 ring-slate-900/100 h-10 w-10 flexCenter cursor-pointer">M</div>
                <div className="ring-2 ring-slate-900/100 h-10 w-10 flexCenter cursor-pointer">L</div>
                <div className="ring-2 ring-slate-900/100 h-10 w-10 flexCenter cursor-pointer">XL</div>
            </div>
