...
const listProduct = () => {
  ...
  return (
    <div className='p-2 box-border bg-white mb-0 rounded-sm w-full mt-4 sm:p-4 sm:m-7'>
      ...
      <div className='max-h-[vh] overflow-auto px-4 text-center'>
        <table className='w-full mx-auto'></table>
        <thead>
        ...
        <tbody>
          {allproducts.map((product,i)=>(
            <tr key={i} className='border-b border-slate-900 text-gray-700 p-6 medium-14'>
              <td className='flexStart sm:flexCenter'>
                <img src={product.image} alt="" height={43} width={43} className='rounded-lg ring-1-slate-900/5 my-1'></img>
                </td>
                <td>
